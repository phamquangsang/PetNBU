...
public class FetchNextPageSubComment implements Runnable {
    ...
    public FetchNextPageSubComment(String parentCommentId , String pagingId, WebService webService, PetDb petDb, AppExecutors appExecutors) {
        mPagingId = pagingId;
    ...
    public void run() {
        ...
        LiveData<ApiResponse<List<Comment>>> result =
                mWebService.getSubCommentsPaging(mParentCommentId, currentPaging.getOldestId(), CommentRepository.COMMENT_PER_PAGE);
