...
class FetchNextPageSubComment(private val mParentCommentId: String, private val mPagingId: String,
                              private val mWebService: WebService, private val mPetDb: PetDb,
    ...
    override fun run() {
        ...
        val result = mWebService.getSubCommentsPaging(mParentCommentId, currentPaging.oldestId!!, CommentRepository.COMMENT_PER_PAGE)
